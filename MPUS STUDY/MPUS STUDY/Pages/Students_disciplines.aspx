<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Students_disciplines.aspx.cs" Inherits="MPUS_STUDY.Pages.Students_disciplines" EnableEventValidation="false" %>
...
<head runat="server">
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.0/umd/popper.min.js"></script>
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.1.0/js/bootstrap.min.js"></script>
    <title>Дисциплины студентов</title>
...
<body>
    <form id="form1" runat="server">
        <asp:SqlDataSource ID="sdsStudentsDisciplines" runat="server"></asp:SqlDataSource>
        <asp:SqlDataSource ID="sdsddlGroupNumber" runat="server"></asp:SqlDataSource>
        <asp:SqlDataSource ID="sdsddlTeachers" runat="server"></asp:SqlDataSource>
        <asp:SqlDataSource ID="sdsddlDiscipline" runat="server"></asp:SqlDataSource>
        <div class="icon-bar">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="nav-link active" href="Students_disciplines.aspx" id="Students_disciplines" aria-haspopup="true" aria-expanded="false">Дисциплины студентов</a>
                            <div class="dropdown-divider"></div>
        ...
        <%-- Навбар--%>
        <h1 class="title">Дисциплины студентов</h1>
        <div class="container">
            <div class="row justify-content-center">
                <div class="form-row col-12">
                    <div class="col-lg-4">
                        <asp:Button ID="btCancel" type="button" class="btn btn-outline-danger btn-block btn-lg mt-2 mb-3" data-toggle="tooltip" data-placement="bottom" title="Отмена результатов поиска" OnClick="btCanсel_Click" runat="server" Text="Отмена" Visible="False" />
                    </div>
                    <div class="col-lg-4">
                        <asp:TextBox class="form-control mt-2 mb-3" ID="tbSearch" runat="server" header="Введите аргумент" type="search"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="tbSearch2" runat="server" ValidationGroup="3" ErrorMessage="Поле не должно быть пустым" class="error" ControlToValidate="tbSearch" Display="Dynamic" EnableClientScript="true"></asp:RequiredFieldValidator>
                    </div>
                    <div class="col-lg-4">
                        <asp:Button ID="btSearch" type="button" class="btn btn-outline-danger btn-block  btn-lg mt-2 mb-3" data-toggle="tooltip" data-placement="bottom" title="Поиск по введенному аргументу" OnClick="btSearch_Click" ValidationGroup="3" runat="server" Text="Поиск" />
                    </div>
                </div>
                <div class="form-row col-12">
                    <div class="form-group col-md-4">
                        <label class="lblText">Номер семестра</label>
                        <asp:TextBox class="form-control" ID="tbSemestrNumber" runat="server" type="search"></asp:TextBox>
                        <asp:RegularExpressionValidator ID="tbSemestrNumber2" ControlToValidate="tbSemestrNumber" ValidationExpression="^[1-8]+$" ErrorMessage="Некорректный ввод символов" Display="Dynamic" class="error" EnableClientScript="true" runat="server" />
                        <asp:RequiredFieldValidator ID="tbSemestrNumber3" runat="server" ValidationGroup="2" ErrorMessage="Поле не должно быть пустым" class="error" ControlToValidate="tbSemestrNumber" Display="Dynamic" EnableClientScript="true"></asp:RequiredFieldValidator>
                    </div>
                    <div class="form-group col-md-4">
                        <label class="lblText">Форма аттестации</label>
                        <asp:TextBox class="form-control" ID="tbAttesstationForm" runat="server" type="search"></asp:TextBox>
                        <asp:RegularExpressionValidator ID="tbAttesstationForm2" ControlToValidate="tbAttesstationForm" ValidationExpression="^[а-яА-Я]+$" ErrorMessage="Некорректный ввод символов" Display="Dynamic" class="error" EnableClientScript="true" runat="server" />
                        <asp:RequiredFieldValidator ID="tbAttesstationForm3" runat="server" ValidationGroup="2" ErrorMessage="Поле не должно быть пустым" class="error" ControlToValidate="tbAttesstationForm" Display="Dynamic" EnableClientScript="true"></asp:RequiredFieldValidator>
                    </div>
                    <div class="form-group col-md-4">
                        <label class="lblText">Номер группы</label>
                        <asp:DropDownList class="form-control" ID="ddlGroupNumber" type="search" runat="server"></asp:DropDownList>
                        <asp:RequiredFieldValidator ID="ddlGroupNumber1" runat="server" ValidationGroup="2" ErrorMessage="Поле не должно быть пустым" class="error" ControlToValidate="ddlGroupNumber" Display="Dynamic" EnableClientScript="true"></asp:RequiredFieldValidator>
                    </div>
                </div>
                <div class="form-row col-md-12">
                    <div class="form-group col-md-6">
                        <label class="lblText">Дисциплина</label>
                        <asp:DropDownList class="form-control" ID="ddlDiscipline" type="search" runat="server"></asp:DropDownList>
                        <asp:RequiredFieldValidator ID="ddlDiscipline1" runat="server" ValidationGroup="2" ErrorMessage="Поле не должно быть пустым" class="error" ControlToValidate="ddlDiscipline" Display="Dynamic" EnableClientScript="true"></asp:RequiredFieldValidator>
                    </div>
                    <div class="form-group col-md-6">
                        <label class="lblText">Фио преподавателя</label>
                        <asp:DropDownList class="form-control" ID="ddlTeachers" type="search" runat="server"></asp:DropDownList>
                        <asp:RequiredFieldValidator ID="ddlTeachers1" runat="server" ValidationGroup="2" ErrorMessage="Поле не должно быть пустым" class="error" ControlToValidate="ddlTeachers" Display="Dynamic" EnableClientScript="true"></asp:RequiredFieldValidator>
                    </div>
                </div>
                <div class="Table mt-2 mb-3" style="overflow-y: auto; -webkit-overflow-scrolling: touch;">
                    <asp:GridView ID="gvStudentsDisciplines" runat="server" Class="table table-dark table-condensed table-hover" AllowSorting="True" CurrentSortDirection="ASC" Font-Size="15px" AlternatingRowStyle-Wrap="false"
                        HeaderStyle-HorizontalAlign="Center" OnRowDataBound="gvStudentsDisciplines_RowDataBound" OnSorting="gvStudentsDisciplines_Sorting" OnRowDeleting="gvStudentsDisciplines_RowDeleting" OnSelectedIndexChanged="gvStudentsDisciplines_SelectedIndexChanged">
                        <Columns>
                            <asp:TemplateField>
                                <ItemTemplate>
                ...
                <div class="form-row col-12">
                    <div class="form-group col-md-6">
                        <asp:Button ID="btInsert" class="btn btn-outline-danger btn-block btn-lg" ValidationGroup="2" runat="server" data-toggle="tooltip" data-placement="bottom" title="Добавление новой записи" Text="Добавить" OnClick="btInsert_Click" />
                    </div>
                    <div class="form-group col-md-6">
    ...
    <script>
        $(document).ready(function () {
            $("#tbSearch").on("keyup", function () {
                ...
                $("#gvStudentsDisciplines tr:has(td)").filter(function () {
