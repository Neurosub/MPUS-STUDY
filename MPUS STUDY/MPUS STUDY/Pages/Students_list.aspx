<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Students_list.aspx.cs" Inherits="MPUS_STUDY.Pages.Students_list" EnableEventValidation="false" %>
...
<body>
    <form id="form1" runat="server">
        <asp:SqlDataSource ID="sdsStudents_list" runat="server"></asp:SqlDataSource>
                ...
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <div class="dropdown-divider"></div>
                            <a class="nav-link active" href="Students_list.aspx" id="Students_list" aria-haspopup="true" aria-expanded="false">Список студентов</a>
                            <div class="dropdown-divider"></div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="form-row col-12">
                    <div class="col-lg-4">
                        <asp:Button ID="btCancel" type="button" class="btn btn-outline-danger btn-block btn-lg mt-2 mb-3" OnClick="btCanсel_Click" data-toggle="tooltip" data-placement="bottom" title="Отмена результатов поиска" runat="server" Text="Отмена" Visible="False" />
                    </div>
                    <div class="col-lg-4">
                    ...
                    <div class="col-lg-4">
                        <asp:Button ID="btSearch" type="button" class="btn btn-outline-danger btn-block  btn-lg mt-2 mb-3" ValidationGroup="3" data-toggle="tooltip" data-placement="bottom" title="Поиск по введенному аргументу" OnClick="btSearch_Click" runat="server" Text="Поиск" />
                    </div>
                </div>
                <div class="form-row col-12">
                    <div class="form-group col-md-4">
                        ...
                        <asp:RegularExpressionValidator ID="tbSurname2" ControlToValidate="tbSurname" ValidationExpression="^[А-Я][а-я]{2,15}$" ErrorMessage="Некорректный ввод символов" Display="Dynamic" class="error" EnableClientScript="true" runat="server" />
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <asp:RegularExpressionValidator ID="tbName2" ControlToValidate="tbName" ValidationExpression="^[А-Я][а-я]{2,15}$" ErrorMessage="Некорректный ввод символов" Display="Dynamic" class="error" EnableClientScript="true" runat="server" />
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <asp:RegularExpressionValidator ID="tbMiddlename2" ControlToValidate="tbMiddlename" ValidationExpression="^[А-Я][а-я]{2,15}$" ErrorMessage="Некорректный ввод символов" Display="Dynamic" class="error" EnableClientScript="true" runat="server" />
                ...
                <div class="Table mt-2 mb-3" style="overflow-y: auto; -webkit-overflow-scrolling: touch;">
                    <asp:GridView ID="gvStudents" runat="server" Class="table table-dark table-condensed table-hover" AllowSorting="True" CurrentSortDirection="ASC" Font-Size="16px" AlternatingRowStyle-Wrap="false"
                        HeaderStyle-HorizontalAlign="Center" OnRowDataBound="gvStudents_RowDataBound" OnSorting="gvStudents_Sorting" OnRowDeleting="gvStudents_RowDeleting" OnSelectedIndexChanged="gvStudents_SelectedIndexChanged">
                        <Columns>
                            <asp:TemplateField>
                                <ItemTemplate>
    ...
    <script>
        $(document).ready(function () {
            $("#tbSearch").on("keyup", function () {
                ...
                $("#gvStudents tr:has(td)").filter(function () {
