<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Group_scores.aspx.cs" Inherits="MPUS_STUDY.Pages.Group_scores" EnableEventValidation="false" %>
...
<body>
    <form id="form1" runat="server">
        <asp:SqlDataSource ID="sdsGroupScores" runat="server"></asp:SqlDataSource>
        <asp:SqlDataSource ID="sdsddlStudentList" runat="server"></asp:SqlDataSource>
        <asp:SqlDataSource ID="sdsGroups" runat="server"></asp:SqlDataSource>
        <asp:SqlDataSource ID="sdsddlStudentsDisciplines" runat="server"></asp:SqlDataSource>
        <div class="icon-bar">
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <div class="dropdown-divider"></div>
                            <a class="nav-link active" href="Group_scores.aspx" id="Group_scores" aria-haspopup="true" aria-expanded="false">Успеваемость групп</a>
                        </div>
                    </li>
        ...
        <%-- Навбар--%>>
        <h1 class="title">Успеваемость студентов</h1>
        <div class="container">
            <div class="row justify-content-center">
                <div class="form-row col-12">
                    <div class="col-lg-4">
                        <asp:Button ID="btCancel" type="button" class="btn btn-outline-danger btn-block btn-lg mt-2 mb-3" data-toggle="tooltip" data-placement="bottom" title="Отмена результатов поиска" runat="server" Text="Отмена" Visible="False" />
                    </div>
                    <div class="col-lg-4">
                    ...
                    <div class="col-lg-4">
                        <asp:Button ID="btSearch" type="button" ValidationGroup="3" class="btn btn-outline-danger btn-block  btn-lg mt-2 mb-3" data-toggle="tooltip" data-placement="bottom" title="Поиск по введенному аргументу" runat="server" Text="Поиск" />
                    </div>
                </div>
                <div class="form-row col-12">
                    <div class="form-group col-md-4">
                        <label class="lblText">Студенты</label>
                        <asp:DropDownList class="form-control" ID="ddlStudentList" type="search" runat="server"></asp:DropDownList>
                        <asp:RequiredFieldValidator ID="ddlStudentList1" runat="server" ValidationGroup="2" ErrorMessage="Поле не должно быть пустым" class="error" ControlToValidate="ddlStudentList" Display="Dynamic" EnableClientScript="true"></asp:RequiredFieldValidator>
                    </div>
                    <div class="form-group col-md-4">
                        <label class="lblText">Дисциплина у студента</label>
                        <asp:DropDownList class="form-control" ID="ddlStudentsDisciplines" type="search" runat="server"></asp:DropDownList>
                        <asp:RequiredFieldValidator ID="ddlStudentsDisciplines1" runat="server" ValidationGroup="2" ErrorMessage="Поле не должно быть пустым" class="error" ControlToValidate="ddlStudentsDisciplines" Display="Dynamic" EnableClientScript="true"></asp:RequiredFieldValidator>
                    </div>
                    <div class="form-group col-md-4">
                        <label class="lblText">Оценка</label>
                        <asp:TextBox class="form-control" ID="tbScore" runat="server" type="search"></asp:TextBox>
                        <asp:RegularExpressionValidator ID="tbScore2" ControlToValidate="tbScore" ValidationGroup="2" ValidationExpression="^[2-5]{1,1}$" ErrorMessage="Некорректный ввод символов" Display="Dynamic" class="error" EnableClientScript="true" runat="server" />
                    </div>
                </div>
                <div class="Table mt-2 mb-3" style="overflow-y: auto; -webkit-overflow-scrolling: touch;">
                    <asp:GridView ID="gvGroupScores" runat="server" Class="table table-dark table-condensed table-hover" AllowSorting="True" CurrentSortDirection="ASC" Font-Size="15px" AlternatingRowStyle-Wrap="false"
                        HeaderStyle-HorizontalAlign="Center" OnRowDataBound="gvGroupScores_RowDataBound" OnSorting="gvGroupScores_Sorting" OnRowDeleting="gvGroupScores_RowDeleting" OnSelectedIndexChanged="gvGroupScores_SelectedIndexChanged">
                        <Columns>
                            <asp:TemplateField>
                                <ItemTemplate>
                ...
                <div class="form-row col-12">
                    <div class="form-group col-md-4">
                        <asp:Button ID="btInsert" class="btn btn-outline-danger btn-block btn-lg" ValidationGroup="2" OnClick="btInsert_Click" data-toggle="tooltip" data-placement="bottom" title="Добавление новой записи" runat="server" Text="Добавить" />
                    </div>
                    <div class="form-group col-md-4">
                        <asp:Button ID="btUpdate" class="btn btn-outline-danger btn-block btn-lg" ValidationGroup="2" OnClick="btUpdate_Click" data-toggle="tooltip" data-placement="bottom" title="Изменение существующей записи" runat="server" Text="Изменить" />
                    </div>
                    <div class="form-group col-md-4">
    ...
    <script>
        $(document).ready(function () {
            $("#tbSearch").on("keyup", function () {
                ...
                $("#gvGroupScores tr:has(td)").filter(function () {
