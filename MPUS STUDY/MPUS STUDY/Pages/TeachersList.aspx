<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TeachersList.aspx.cs" Inherits="MPUS_STUDY.Pages.TeachersList" EnableEventValidation="false" %>
...
<body>
    <form id="form1" runat="server">
        <asp:SqlDataSource ID="sdsTeachers" runat="server"></asp:SqlDataSource>
        <div class="icon-bar">
                ...
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <div class="dropdown-divider"></div>
                            <a class="nav-link active" href="TeachersList.aspx" id="TeachersList" aria-haspopup="true" aria-expanded="false">Список преподавателей</a>
                            <div class="dropdown-divider"></div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="Table mt-2 mb-3" style="overflow-y: auto; -webkit-overflow-scrolling: touch;">
                    <asp:GridView ID="gvTeachers" runat="server" Class="table table-dark table-condensed table-hover" AllowSorting="True" CurrentSortDirection="ASC" Font-Size="16px" AlternatingRowStyle-Wrap="false"
                        HeaderStyle-HorizontalAlign="Center" OnRowDataBound="gvTeachers_RowDataBound" OnSorting="gvTeachers_Sorting" OnRowDeleting="gvTeachers_RowDeleting" OnSelectedIndexChanged="gvTeachers_SelectedIndexChanged">
                        <Columns>
                            <asp:TemplateField>
                                <ItemTemplate>
    ...
    <script>
        $(document).ready(function () {
            $("#tbSearch").on("keyup", function () {
                ...
                $("#gvTeachers tr:has(td)").filter(function () {
