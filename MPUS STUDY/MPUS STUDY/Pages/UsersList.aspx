<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UsersList.aspx.cs" Inherits="MPUS_STUDY.Pages.UsersList" EnableEventValidation="false" %>
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li runat="server" class="nav-item dropdown" id="admin" visible="true">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <div class="dropdown-divider"></div>
                            <a class="nav-link active" href="UsersList.aspx" id="UsersList" aria-haspopup="true" aria-expanded="false">Список пользователей</a>
                        </div>
                    </li>
                    <li>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="form-row col-12">
                    <div class="col-lg-4">
                        <asp:Button ID="btCancel" type="button" class="btn btn-outline-danger btn-block btn-lg mt-2 mb-3" OnClick="btCanсel_Click" runat="server" data-toggle="tooltip" data-placement="bottom" title="Отмена результатов поиска" Text="Отмена" Visible="False" />
                    </div>
                    <div class="col-lg-4">
                    ...
                    <div class="col-lg-4">
                        <asp:Button ID="btSearch" type="button" class="btn btn-outline-danger btn-block  btn-lg mt-2 mb-3" ValidationGroup="3" OnClick="btSearch_Click" data-toggle="tooltip" data-placement="bottom" title="Поиск по введенному аргументу" runat="server" Text="Поиск" />
                    </div>
                </div>
                <div class="form-row col-12">
                    <div class="form-group col-md-4">
                        ...
                        <asp:RegularExpressionValidator ID="tbSurname2" ControlToValidate="tbSurname" ValidationExpression="^[А-Я][а-я]{2,20}$" ErrorMessage="Некорректный ввод символов" Display="Dynamic" class="error" EnableClientScript="true" runat="server" />
                        <asp:RequiredFieldValidator ID="tbSurname3" runat="server" ValidationGroup="2" ErrorMessage="Поле не должно быть пустым" class="error" ControlToValidate="tbSurname" Display="Dynamic" EnableClientScript="true"></asp:RequiredFieldValidator>
                    </div>
                    <div class="form-group col-md-4">
                        <label class="lblText">Имя</label>
                        <asp:TextBox class="form-control" ID="tbName" runat="server" type="search"></asp:TextBox>
                        <asp:RegularExpressionValidator ID="tbName2" ControlToValidate="tbName" ValidationExpression="^[А-Я][а-я]{2,20}$" ErrorMessage="Некорректный ввод символов" Display="Dynamic" class="error" EnableClientScript="true" runat="server" />
                        <asp:RequiredFieldValidator ID="tbName3" runat="server" ValidationGroup="2" ErrorMessage="Поле не должно быть пустым" class="error" ControlToValidate="tbName" Display="Dynamic" EnableClientScript="true"></asp:RequiredFieldValidator>
                    </div>
                    <div class="form-group col-md-4">
                        <label class="lblText">Отчество</label>
                        <asp:TextBox class="form-control" ID="tbMiddlename" type="search" runat="server"></asp:TextBox>
                        <asp:RegularExpressionValidator ID="tbMiddlename2" ControlToValidate="tbMiddlename" ValidationExpression="^[А-Я][а-я]{2,20}$" ErrorMessage="Некорректный ввод символов" Display="Dynamic" class="error" EnableClientScript="true" runat="server" />
                        <asp:RequiredFieldValidator ID="tbMiddlename3" runat="server" ValidationGroup="2" ErrorMessage="Поле не должно быть пустым" class="error" ControlToValidate="tbMiddlename" Display="Dynamic" EnableClientScript="true"></asp:RequiredFieldValidator>
                    </div>
                </div>
                <div class="form-row col-12">
                    <div class="form-group col-md-4">
                        <label class="lblText">Логин</label>
                        <asp:TextBox class="form-control" ID="tbLogin" type="search" runat="server"></asp:TextBox>
                        <asp:RegularExpressionValidator ID="tbLogin1" ControlToValidate="tbLogin" ValidationExpression="^[a-zA-Z][a-zA-Z0-9]{5,30}$" ErrorMessage="Некорректный ввод символов" Display="Dynamic" class="error" EnableClientScript="true" runat="server" />
                        <asp:RequiredFieldValidator ID="tbLogin2" runat="server" ValidationGroup="2" ErrorMessage="Поле не должно быть пустым" class="error" ControlToValidate="tbLogin" Display="Dynamic" EnableClientScript="true"></asp:RequiredFieldValidator>
                        <asp:Label runat="server" ID="lblLoginCheck" Class="error" ValidationGroup="2" Text="Логин уже занят, добавьте цифру" Visible="false"></asp:Label>
                    </div>
                    <div class="form-group col-md-4">
                        <label class="lblText">Пароль</label>
                        <asp:TextBox class="form-control" ID="tbPassword" type="search" runat="server"></asp:TextBox>
                        <asp:RegularExpressionValidator ID="tbPassword1" ValidationGroup="2" ControlToValidate="tbPassword" ValidationExpression="(?=^.{5,}$)((?=.*\d)|(?=.*\W+))(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*$" ErrorMessage="Некорректный ввод символов, добавьте цифры и спец. символы" Display="Dynamic" class="error" EnableClientScript="true" runat="server" />
                        <asp:RequiredFieldValidator ID="tbPassword2" runat="server" ValidationGroup="2" ErrorMessage="Поле не должно быть пустым" class="error" ControlToValidate="tbPassword" Display="Dynamic" EnableClientScript="true"></asp:RequiredFieldValidator>
                    </div>
                    <div class="form-group col-md-4">
                        <label class="lblText">Должность</label>
                        <asp:DropDownList class="form-control" ID="ddlPost" type="search" runat="server"></asp:DropDownList>
                        <asp:RequiredFieldValidator ID="ddlPost1" runat="server" ValidationGroup="2" ErrorMessage="Поле не должно быть пустым" class="error" ControlToValidate="ddlPost" Display="Dynamic" EnableClientScript="true"></asp:RequiredFieldValidator>
                    </div>
                </div>
                <asp:Label runat="server" ID="lblError" Text="Нельзя удалить стандартную запись! Вы можете изменить её данные." Visible="false" Class="Error"></asp:Label>
                <div class="Table mt-2 mb-3" style="overflow-y: auto; -webkit-overflow-scrolling: touch;">
                    <asp:GridView ID="gvUsers" runat="server" Class="table table-dark table-condensed table-hover" AllowSorting="True" CurrentSortDirection="ASC" Font-Size="14px" AlternatingRowStyle-Wrap="false"
                        HeaderStyle-HorizontalAlign="Center" OnRowDataBound="gvUsers_RowDataBound" OnSorting="gvUsers_Sorting" OnRowDeleting="gvUsers_RowDeleting" OnSelectedIndexChanged="gvUsers_SelectedIndexChanged">
                        <Columns>
                            <asp:TemplateField>
                                <ItemTemplate>
                ...
                <div class="form-row col-12">
                    <div class="form-group col-md-4">
                        <asp:Button ID="btInsert" class="btn btn-outline-danger btn-block btn-lg" ValidationGroup="2" runat="server" Text="Добавить" data-toggle="tooltip" data-placement="bottom" title="Добавление новой записи" OnClick="btInsert_Click" />
                    </div>
                    <div class="form-group col-md-4">
                        <asp:Button ID="btUpdate" class="btn btn-outline-danger btn-block btn-lg" ValidationGroup="2" runat="server" data-toggle="tooltip" data-placement="bottom" title="Изменение существующей записи" Text="Изменить" OnClick="btUpdate_Click" />
                    </div>
                   <div class="form-group col-md-4">
                        <asp:Button ID="btCreateExcel" class="btn btn-outline-danger btn-block btn-lg" OnClick="btCreateExcel_Click" data-toggle="tooltip" data-placement="bottom" title="Экспорт всех записей внесенных в таблицу" runat="server" Text="Экспорт в Excel" />
                    </div>
                </div>
                <div class="form-row col-12">
                    <div class="form-group col-md-8">
                         <label class="lblText">Введите зашифрованный пароль</label>
                        <asp:TextBox class="form-control" ID="tbDecrypt" type="search" runat="server"></asp:TextBox>                
                        <asp:RequiredFieldValidator ID="tbDecrypt1" runat="server" ValidationGroup="5" ErrorMessage="Поле не должно быть пустым" class="error" ControlToValidate="tbDecrypt" Display="Dynamic" EnableClientScript="true"></asp:RequiredFieldValidator>
                    </div>                    
                   <div class="form-group col-md-4">
                        <asp:Button ID="btDecrypt" class="btn btn-outline-danger btn-block btn-lg" OnClick="btDecrypt_Click" ValidationGroup="5" data-toggle="tooltip" data-placement="bottom" title="Расшифровка пароля" runat="server" Text="Расшифровать пароль" />
                    </div>
                    <asp:Label runat="server" ID="lblDecrypt" Class="Succes mt-2 mb-3" Text="" Visible="false"></asp:Label>
                </div>
            </div>
        </div>
    </form>
    <script>
        $(document).ready(function () {
            $("#tbSearch").on("keyup", function () {
                ...
                $("#gvUsers tr:has(td)").filter(function () {
