<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Groups.aspx.cs" Inherits="MPUS_STUDY.Pages.Groups" EnableEventValidation="false" %>
...
<body>
    <form id="form1" runat="server">
        <asp:SqlDataSource ID="sdsGroups" runat="server"></asp:SqlDataSource>
                ...
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="nav-link active " href="Groups.aspx" id="Groups" aria-haspopup="true" aria-expanded="false">Список групп</a>
                    ...
                    <li>
                        ...
                        <asp:Button ID="btExit" type="button" class="btn" OnClick="btExit_Click" data-toggle="tooltip" data-placement="bottom" title="Выход из учетной записи" RegularExpressionValidator="False" runat="server" Text="ВЫЙТИ" />
                    </li>
                </ul>
            </div>
        </nav>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="form-row col-12">
                    <div class="col-lg-4">
                        <asp:Button ID="btCancel" type="button" data-toggle="tooltip" data-placement="bottom" title="Отмена результатов поиска" class="btn btn-outline-danger btn-block btn-lg mt-2 mb-3" OnClick="btCanсel_Click" RegularExpressionValidator="False" runat="server" Text="Отмена" Visible="False" />
                    </div>
                    <div class="col-lg-4">
                    ...
                    <div class="col-lg-4">
                        <asp:Button ID="btSearch" type="button" class="btn btn-outline-danger btn-block btn-lg mt-2 mb-3" data-toggle="tooltip" data-placement="bottom" title="Поиск по введенному аргументу" ValidationGroup="3" RegularExpressionValidator="False" OnClick="btSearch_Click" runat="server" Text="Поиск" />
                    </div>
                </div>
                <div class="form-row col-12">
                    <div class="form-group col-md-6">
                        <label class="lblText">Номер группы</label>
                        <asp:TextBox class="form-control" ID="tbGroupNumber" onkeyup="myFunction()" type="search" runat="server"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="tbGroupNumber1" runat="server" ErrorMessage="Поле не должно быть пустым" ValidationGroup="2" class="error" ControlToValidate="tbGroupNumber" Display="Dynamic" EnableClientScript="true"></asp:RequiredFieldValidator>
                        <asp:RegularExpressionValidator ID="tbGroupNumber2" ControlToValidate="tbGroupNumber" ValidationExpression="^[а-яА-Я][а-яА-Я1-9-]{5,10}$" ErrorMessage="Некорректный ввод символов" Display="Dynamic" class="error" EnableClientScript="true" runat="server" />
                    </div>
                    <div class="form-group col-md-6">
                        <label class="lblText">Номер курса</label>
                        <asp:TextBox class="form-control" ID="tbCourseNumber" runat="server" type="search"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="tbCourseNumber1" runat="server" ErrorMessage="Поле не должно быть пустым" ValidationGroup="2" class="error" ControlToValidate="tbCourseNumber" Display="Dynamic" EnableClientScript="true"></asp:RequiredFieldValidator>
                        <asp:RegularExpressionValidator ID="tbCourseNumber2" ControlToValidate="tbCourseNumber" ValidationExpression="^[1-4]{1,1}$" ErrorMessage="Некорректный ввод символов" Display="Dynamic" class="error" EnableClientScript="true" runat="server" />
                    </div>
                </div>
                <div class="form-row col-md-12">
                    <div class="form-group col-md-12">
                        <label class="lblText">Специальность</label>
                        <asp:DropDownList class="form-control" ID="ddlSpecialization" type="search" runat="server"></asp:DropDownList>
                        <asp:RequiredFieldValidator ID="ddlSpecialization1" runat="server" ValidationGroup="2" ErrorMessage="Поле не должно быть пустым" class="error" ControlToValidate="ddlSpecialization" Display="Dynamic" EnableClientScript="true"></asp:RequiredFieldValidator>
                    </div>
                </div>
                <div class="Table mt-2 mb-3" style="overflow-y: auto; -webkit-overflow-scrolling: touch;">
                    <asp:GridView ID="gvGroups" runat="server" Class="table table-dark table-condensed table-hover" AllowSorting="True" CurrentSortDirection="ASC" Font-Size="16px" AlternatingRowStyle-Wrap="false"
                        HeaderStyle-HorizontalAlign="Center" OnRowDataBound="gvGroups_RowDataBound" OnRowDeleting="gvGroups_RowDeleting" OnSelectedIndexChanged="gvGroups_SelectedIndexChanged" OnSorting="gvGroups_Sorting">
                        <Columns>
                            <asp:TemplateField>
                                <ItemTemplate>
                ...
                <div class="form-row col-12">
                    <div class="form-group col-md-6">
                        <asp:Button ID="btInsert" class="btn btn-outline-danger btn-block btn-lg" data-toggle="tooltip" data-placement="bottom" title="Добавление новой записи" runat="server" ValidationGroup="2" OnClick="btInsert_Click" Text="Добавить" />
                    </div>
                    <div class="form-group col-md-6">
                        <asp:Button ID="btUpdate" class="btn btn-outline-danger btn-block btn-lg" data-toggle="tooltip" data-placement="bottom" title="Изменение существующей записи" runat="server" ValidationGroup="2" OnClick="btUpdate_Click" Text="Изменить" />
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        function myFunction() {
            var x = document.getElementById("tbGroupNumber");
    ...
    <script>
        $(document).ready(function () {
            $("#tbSearch").on("keyup", function () {
                ...
                $("#gvGroups tr:has(td)").filter(function () {
