<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Disciplines.aspx.cs" Inherits="MPUS_STUDY.Pages.Disciplines" EnableEventValidation="false" %>
...
<body>
    <form id="form1" runat="server">
        <asp:SqlDataSource ID="sdsDisciplines" runat="server"></asp:SqlDataSource>
                ...
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <div class="dropdown-divider"></div>
                            <a class="nav-link active " href="Disciplines.aspx" id="Disciplines" aria-haspopup="true" aria-expanded="false">Список дисциплин</a>
                            <div class="dropdown-divider"></div>
                    ...
                    <li>
                        ...
                        <asp:Button ID="btExit" type="button" class="btn" data-toggle="tooltip" data-placement="bottom" title="Выход из учётной записи" OnClick="btExit_Click" RegularExpressionValidator="False" runat="server" Text="ВЫЙТИ" />
                    </li>
                </ul>
            </div>
        </nav>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="form-row col-12">
                    ...
                    <div class="col-lg-4">
                        <asp:Button ID="btSearch" type="button" class="btn btn-outline-danger btn-block  btn-lg mt-2 mb-3" data-toggle="tooltip" data-placement="bottom" title="Поиск по введенному аргументу" ValidationGroup="3" OnClick="btSearch_Click" runat="server" Text="Поиск" />
                    </div>
                </div>
                <div class="form-row col-12">
                    <div class="form-group col-md-4">
                        <label class="lblText">Тип дисциплины</label>
                        <asp:TextBox class="form-control" ID="tbTypeDisciplines" onkeyup="myFunction()" type="search" runat="server"></asp:TextBox>
                        <asp:RegularExpressionValidator ID="tbTypeDisciplines2" ControlToValidate="tbTypeDisciplines" ValidationExpression="^[а-яА-ЯёЁ]+$" ErrorMessage="Некорректный ввод символов" Display="Dynamic" class="error" EnableClientScript="true" runat="server" />
                        <asp:RequiredFieldValidator ID="tbTypeDisciplines3" runat="server" ValidationGroup="2" ErrorMessage="Поле не должно быть пустым" class="error" ControlToValidate="tbTypeDisciplines" Display="Dynamic" EnableClientScript="true"></asp:RequiredFieldValidator>

                    </div>
                    <div class="form-group col-md-4">
                        <label class="lblText">Код предмета</label>
                        <asp:TextBox class="form-control" ID="tbSubjectCode" runat="server" type="search"></asp:TextBox>
                        <asp:RegularExpressionValidator ID="tbSubjectCode2" ControlToValidate="tbSubjectCode" ValidationExpression="^[0-9.]{2,8}$" ErrorMessage="Некорректный ввод символов" Display="Dynamic" class="error" EnableClientScript="true" runat="server" />
                        <asp:RequiredFieldValidator ID="tbSubjectCode3" runat="server" ValidationGroup="2" ErrorMessage="Поле не должно быть пустым" class="error" ControlToValidate="tbSubjectCode" Display="Dynamic" EnableClientScript="true"></asp:RequiredFieldValidator>

                    </div>
                    <div class="form-group col-md-4">
                        <label class="lblText">Название дисциплины</label>
                        <asp:TextBox class="form-control" ID="tbNameDisciplines" type="search" runat="server"></asp:TextBox>
                        <asp:RegularExpressionValidator ID="tbNameDisciplines2" ControlToValidate="tbNameDisciplines" ValidationExpression="^[А-Я а-я . , ( ) -]{5,200}$" ErrorMessage="Некорректный ввод символов" Display="Dynamic" class="error" EnableClientScript="true" runat="server" />
                        <asp:RequiredFieldValidator ID="tbNameDisciplines3" runat="server" ValidationGroup="2" ErrorMessage="Поле не должно быть пустым" class="error" ControlToValidate="tbNameDisciplines" Display="Dynamic" EnableClientScript="true"></asp:RequiredFieldValidator>

                    </div>
                </div>
                <div class="form-row col-md-12">
                    <div class="form-group col-md-12">
                        <label class="lblText">Профессиональный модуль</label>
                        <asp:DropDownList class="form-control" ID="ddlProfessionalModule" type="search" runat="server"></asp:DropDownList>
                        <asp:RequiredFieldValidator ID="ddlProfessionalModule1" runat="server" ErrorMessage="Поле не должно быть пустым" class="error" ControlToValidate="ddlProfessionalModule" Display="Dynamic" EnableClientScript="true"></asp:RequiredFieldValidator>
                    </div>
                </div>
                <div class="Table mt-2 mb-3" style="overflow-y: auto; -webkit-overflow-scrolling: touch;">
                    <asp:GridView ID="gvDisciplines" runat="server" Class="table table-dark table-condensed table-hover" AllowSorting="True" CurrentSortDirection="ASC" Font-Size="16px" AlternatingRowStyle-Wrap="false"
                        HeaderStyle-HorizontalAlign="Center" OnRowDataBound="gvDisciplines_RowDataBound" OnSorting="gvDisciplines_Sorting" OnRowDeleting="gvDisciplines_RowDeleting" OnSelectedIndexChanged="gvDisciplines_SelectedIndexChanged">
                        <Columns>
                            <asp:TemplateField>
                                <ItemTemplate>
                ...
                <div class="form-row col-12">
                    <div class="form-group col-md-6">
                        <asp:Button ID="btInsert" class="btn btn-outline-danger btn-block btn-lg" ValidationGroup="2" data-toggle="tooltip" data-placement="bottom" title="Добавление новой записи" runat="server" Text="Добавить" OnClick="btInsert_Click" />
                    </div>
                    <div class="form-group col-md-6">
                        <asp:Button ID="btUpdate" class="btn btn-outline-danger btn-block btn-lg" ValidationGroup="2" data-toggle="tooltip" data-placement="bottom" title="Изменение существующей записи" runat="server" Text="Изменить" OnClick="btUpdate_Click" />
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        function myFunction() {
            var x = document.getElementById("tbTypeDisciplines");
    ...
    <script>
        $(document).ready(function () {
            $("#tbSearch").on("keyup", function () {
                ...
                $("#gvDisciplines tr:has(td)").filter(function () {
