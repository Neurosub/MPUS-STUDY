<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Specialization.aspx.cs" Inherits="MPUS_STUDY.Pages.Specialization" EnableEventValidation="false" %>
...
<body>
    <form id="form1" runat="server">
        <asp:SqlDataSource ID="sdsSpecialization" runat="server"></asp:SqlDataSource>
        <div class="icon-bar">
        ...
        <%-- Навбар--%>>
        <h1 class="title">Список специальностей</h1>
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="form-row col-12">
                    <div class="form-group col-md-6">
                        <label class="lblText">Номер специальности</label>
                        <asp:TextBox class="form-control" ID="tbNumberSpecialty" runat="server" type="search"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="tbNumberSpecialty1" runat="server" ErrorMessage="Поле не должно быть пустым" ValidationGroup="2" class="error" ControlToValidate="tbNumberSpecialty" Display="Dynamic" EnableClientScript="true"></asp:RequiredFieldValidator>
                        <asp:RegularExpressionValidator ID="tbNumberSpecialty2" ControlToValidate="tbNumberSpecialty" ValidationExpression="^[0-9.]{7,10}$" ErrorMessage="Некорректный ввод символов" Display="Dynamic" class="error" EnableClientScript="true" runat="server" />
                    </div>
                    <div class="form-group col-md-6">
                        <label class="lblText">Название специальности</label>
                        <asp:TextBox class="form-control" ID="tbNameSpecialty" type="search" runat="server"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="tbNameSpecialty1" runat="server" ErrorMessage="Поле не должно быть пустым" ValidationGroup="2" class="error" ControlToValidate="tbNameSpecialty" Display="Dynamic" EnableClientScript="true"></asp:RequiredFieldValidator>
                        <asp:RegularExpressionValidator ID="tbNameSpecialty2" ControlToValidate="tbNameSpecialty" ValidationExpression="^[А-Я][а-я А-Я , . - ( )]{5,200}$" ErrorMessage="Некорректный ввод символов" Display="Dynamic" class="error" EnableClientScript="true" runat="server" />
                    </div>
                </div>
                <div class="Table mt-2 mb-3" style="overflow-y: auto; -webkit-overflow-scrolling: touch;">
                    <asp:GridView ID="gvSpecialization" runat="server" Class="table table-dark table-condensed table-hover" AllowSorting="True" CurrentSortDirection="ASC" Font-Size="16px" AlternatingRowStyle-Wrap="false"
                        HeaderStyle-HorizontalAlign="Center" OnRowDataBound="gvSpecialization_RowDataBound" OnRowDeleting="gvSpecialization_RowDeleting" OnSelectedIndexChanged="gvSpecialization_SelectedIndexChanged" OnSorting="gvSpecialization_Sorting">
                        <Columns>
                            <asp:TemplateField>
                                <ItemTemplate>
    ...
    <script>
        $(document).ready(function () {
            $("#tbSearch").on("keyup", function () {
                ...
                $("#gvSpecialization tr:has(td)").filter(function () {
