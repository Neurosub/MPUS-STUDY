<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProfessionalModule.aspx.cs" Inherits="MPUS_STUDY.Pages.ProfessionalModule" EnableEventValidation="false" %>
...
<body>
    <form id="form1" runat="server">
        <asp:SqlDataSource ID="sdsProfessionalModule" runat="server"></asp:SqlDataSource>
        <div class="icon-bar">
                ...
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <div class="dropdown-divider"></div>
                            <a class="nav-link active" href="ProfessionalModule.aspx" id="ProfessionalModule" aria-haspopup="true" aria-expanded="false">Список профессиональных модулей</a>
                        </div>
                    </li>
                    <li class="nav-item dropdown">
        ...
        <%-- Навбар--%>>
        <h1 class="title">Список профессиональных модулей</h1>
        <div class="container">
            <div class="row justify-content-center">
                        <asp:Label runat="server" ID="lblError" Text="Нельзя удалить или изменить стандартную запись!" Visible="false" Class="error"></asp:Label>
                ...
                <div class="form-row col-12">
                    <div class="form-group col-md-6">
                        <label class="lblText">Код профессионального модуля</label>
                        <asp:TextBox class="form-control" ID="tbCodeProfModule" runat="server" onkeyup="myFunction()" type="search"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="tbCodeProfModule1" runat="server" ErrorMessage="Поле не должно быть пустым" ValidationGroup="2" class="error" ControlToValidate="tbCodeProfModule" Display="Dynamic" EnableClientScript="true"></asp:RequiredFieldValidator>
                        <asp:RegularExpressionValidator ID="tbCodeProfModule2" ControlToValidate="tbCodeProfModule" ValidationExpression="^[А-Я0-9.]{2,6}$" ErrorMessage="Некорректный ввод символов" Display="Dynamic" class="error" EnableClientScript="true" runat="server" />
                    </div>
                    <div class="form-group col-md-6">
                        <label class="lblText">Название профессионального модуля</label>
                        <asp:TextBox class="form-control" ID="tbNameProfModule" type="search" runat="server"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="tbNameProfModule1" runat="server" ErrorMessage="Поле не должно быть пустым" ValidationGroup="2" class="error" ControlToValidate="tbNameProfModule" Display="Dynamic" EnableClientScript="true"></asp:RequiredFieldValidator>
                        <asp:RegularExpressionValidator ID="tbNameProfModule2" ControlToValidate="tbNameProfModule" ValidationExpression="^[А-Я][а-я А-Я , . - ( )]{5,200}$" ErrorMessage="Некорректный ввод символов" Display="Dynamic" class="error" EnableClientScript="true" runat="server" />
                    </div>
                </div>                                            
                <div class="Table mt-2 mb-3" style="overflow-y: auto; -webkit-overflow-scrolling: touch;">
                    <asp:GridView ID="gvProfModule" runat="server" Class="table table-dark table-condensed table-hover" AllowSorting="True" CurrentSortDirection="ASC" Font-Size="16px" AlternatingRowStyle-Wrap="false"
                        HeaderStyle-HorizontalAlign="Center" OnRowDataBound="gvProfModule_RowDataBound" OnRowDeleting="gvProfModule_RowDeleting" OnSelectedIndexChanged="gvProfModule_SelectedIndexChanged" OnSorting="gvProfModule_Sorting">
                        <Columns>
                            <asp:TemplateField>
                                <ItemTemplate>
                ...
                <div class="form-row col-12">
                    <div class="form-group col-md-6">
                        <asp:Button ID="btInsert" class="btn btn-outline-danger btn-block btn-lg" runat="server" ValidationGroup="2" data-toggle="tooltip" data-placement="bottom" title="Добавление новой записи" OnClick="btInsert_Click" Text="Добавить" />
                    </div>
                    <div class="form-group col-md-6">
    ...
    <script>
        $(document).ready(function () {
            $("#tbSearch").on("keyup", function () {
                ...
                $("#gvProfModule tr:has(td)").filter(function () {
    ...
    <script>
        function myFunction() {
            var x = document.getElementById("tbCodeProfModule");
